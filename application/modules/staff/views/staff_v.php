...
<!-- Mirrored from seantheme.com/color-admin-v1.4/admin/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Dec 2014 13:43:40 GMT -->
<head>
    <meta charset="utf-8" />
    <title><?php echo $userdetails[0]['ssg_name']; ?></title>
    ...
    <link href="<?php echo base_url('assets/staff/plugins/jquery-ui-1.10.4/themes/base/minified/jquery-ui.min.css') ?>" rel="stylesheet" />
    <link href="<?php echo base_url('assets/staff/plugins/bootstrap-3.2.0/css/bootstrap.min.css') ?>" rel="stylesheet" />
    <link href="<?php echo base_url('assets/staff/plugins/font-awesome-4.2.0/css/font-awesome.min.css') ?>" rel="stylesheet" />
    <link href="<?php echo base_url('assets/staff/css/animate.min.css') ?>" rel="stylesheet" />
    <link href="<?php echo base_url('assets/staff/css/style.min.css') ?>" rel="stylesheet" />
    <link href="<?php echo base_url('assets/staff/css/style-responsive.min.css') ?>" rel="stylesheet" />
    <link href="<?php echo base_url('assets/staff/css/theme/default.css') ?>" rel="stylesheet" id="theme" />
    <!-- ================== END BASE CSS STYLE ================== -->
    
    <!-- ================== BEGIN PAGE LEVEL STYLE ================== -->
    <link href="<?php echo base_url('assets/staff/plugins/jquery-jvectormap/jquery-jvectormap-1.2.2.css') ?>" rel="stylesheet" />
    <link href="<?php echo base_url('assets/staff/plugins/bootstrap-datepicker/css/datepicker.css') ?>" rel="stylesheet" />
    <link href="<?php echo base_url('assets/staff/plugins/bootstrap-datepicker/css/datepicker3.css') ?>" rel="stylesheet" />
    <link href="<?php echo base_url('assets/staff/plugins/gritter/css/jquery.gritter.css') ?>" rel="stylesheet" />
...
<body>
        ...
        <div id="header" class="header navbar navbar-default navbar-fixed-top">
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    <a href="index.html" class="navbar-brand"><span class="navbar-logo"></span><?php echo $school; ?></a>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu media-list pull-right animated fadeInDown">
                            ...
                            <li class="media">
                                <a href="javascript:;">
                                    <div class="pull-left"><img src="<?php echo base_url('assets/staff/img/user-1.jpg') ?>" class="media-object" alt="" /></div>
                                    <div class="media-body">
                            ...
                            <li class="media">
                                <a href="javascript:;">
                                    <div class="pull-left"><img src="<?php echo base_url('assets/staff/img/user-2.jpg') ?>" class="media-object" alt="" /></div>
                                    <div class="media-body">
                    ...
                    <li class="dropdown navbar-user">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?php echo base_url('assets/staff/img/user-13.jpg') ?>" alt="" /> 
                            <span class="hidden-xs"><?php echo $userdetails[0]['f_name']." ".$userdetails[0]['s_name']; ?></span> <b class="caret"></b>
                        </a>
                                ...
                                <ul class="media-list media-list-with-divider">
                                    <li class="media media-lg">
                                        <a href="javascript:;" class="pull-left">
                                            <img class="media-object" src="<?php echo base_url('assets/staff/img/gallery/gallery-1.jpg') ?>" alt="" />
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <li class="media media-lg">
                                        <a href="javascript:;" class="pull-left">
                                            <img class="media-object" src="<?php echo base_url('assets/staff/img/gallery/gallery-10.jpg') ?>" alt="" />
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <li class="media media-lg">
                                        <a href="javascript:;" class="pull-left">
                                            <img class="media-object" src="<?php echo base_url('assets/staff/img/gallery/gallery-7.jpg') ?>" alt="" />
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <li class="media media-lg">
                                        <a href="javascript:;" class="pull-left">
                                            <img class="media-object" src="<?php echo base_url('assets/staff/img/gallery/gallery-8.jpg') ?>" alt="" />
                                        </a>
                                        <div class="media-body">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="hidden-sm">
                                                <a href="javascript:;">
                                                    <img src="<?php echo base_url('assets/staff/img/product/product-1.png') ?>" alt=""  />
                                                </a>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="hidden-sm">
                                                <a href="javascript:;">
                                                    <img src="<?php echo base_url('assets/staff/img/product/product-2.png') ?>" alt="" />
                                                </a>
                                            </td>
                                            <td>
                                                <h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, eget faucibus nibh placerat.</a></h6>
                                        ...
                                        <tr>
                                            ...
                                            <td class="hidden-sm">
                                                <a href="javascript:;">
                                                    <img src="<?php echo base_url('assets/staff/img/product/product-3.png') ?>" alt="" />
                                                </a>
                                            </td>
                                            <td>
                                                <h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, eget faucibus nibh placerat.</a></h6>
                                        ...
                                        <tr>
                                            ...
                                            <td class="hidden-sm">
                                                <a href="javascript:;">
                                                    <img src="<?php echo base_url('assets/staff/img/product/product-4.png') ?>" alt="" />
                                                </a>
                                            </td>
                                            <td>
                                                <h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, eget faucibus nibh placerat.</a></h6>
                                        ...
                                        <tr>
                                            ...
                                            <td class="hidden-tablet hidden-phone">
                                                <a href="javascript:;">
                                                    <img src="<?php echo base_url('assets/staff/img/product/product-5.png') ?>" alt="" />
                                                </a>
                                            </td>
                                            <td>
                                                <h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, eget faucibus nibh placerat.</a></h6>
                            ...
                            <div class="height-sm" data-scrollbar="true">
                                <ul class="media-list media-list-with-divider">
                                    <li class="media media-sm">
                                        <a href="javascript:;" class="pull-left">
                                            <img src="<?php echo base_url('assets/staff/img/user-1.jpg') ?>" alt="" class="media-object rounded-corner" />
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <li class="media media-sm">
                                        <a href="javascript:;" class="pull-left">
                                            <img src="<?php echo base_url('assets/staff/img/user-2.jpg') ?>" alt="" class="media-object rounded-corner" />
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <li class="media media-sm">
                                        <a href="javascript:;" class="pull-left">
                                            <img src="<?php echo base_url('assets/staff/img/user-3.jpg') ?>" alt="" class="media-object rounded-corner" />
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <li class="media media-sm">
                                        <a href="javascript:;" class="pull-left">
                                            <img src="<?php echo base_url('assets/staff/img/user-4.jpg') ?>" alt="" class="media-object rounded-corner" />
                                        </a>
                                        <div class="media-body">
                        ...
                        <div class="panel-body">
                            <div class="height-sm" data-scrollbar="true">
                                <ul class="media-list media-list-with-divider media-messaging">
                                    <li class="media media-sm">
                                        <a href="javascript:;" class="pull-left">
                                            <img src="<?php echo base_url('assets/staff/img/user-5.jpg') ?>" alt="" class="media-object rounded-corner" />
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <li class="media media-sm">
                                        <a href="javascript:;" class="pull-left">
                                            <img src="<?php echo base_url('assets/staff/img/user-6.jpg') ?>" alt="" class="media-object rounded-corner" />
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <li class="media media-sm">
                                        <a href="javascript:;" class="pull-left">
                                            <img src="<?php echo base_url('assets/staff/img/user-8.jpg') ?>" alt="" class="media-object rounded-corner" />
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <li class="media media-sm">
                                        <a href="javascript:;" class="pull-left">
                                            <img src="<?php echo base_url('assets/staff/img/user-7.jpg') ?>" alt="" class="media-object rounded-corner" />
                                        </a>
                                        <div class="media-body">
                                            <h5 class="media-heading">John Doe</h5>
    ...
    <!-- ================== BEGIN BASE JS ================== -->
    <script src="<?php echo base_url('assets/staff/plugins/jquery-1.8.2/jquery-1.8.2.min.js') ?>"></script>
    <script src="<?php echo base_url('assets/staff/plugins/jquery-ui-1.10.4/ui/minified/jquery-ui.min.js') ?>"></script>
    <script src="<?php echo base_url('assets/staff/plugins/bootstrap-3.2.0/js/bootstrap.min.js') ?>"></script>
    <!--[if lt IE 9]>
        <script src="<?php echo base_url('assets/staff/crossbrowserjs/html5shiv.js') ?>"></script>
        <script src="<?php echo base_url('assets/staff/crossbrowserjs/respond.min.js') ?>"></script>
        <script src="<?php echo base_url('assets/staff/crossbrowserjs/excanvas.min.js') ?>"></script>
    <![endif]-->
    <script src="<?php echo base_url('assets/staff/plugins/slimscroll/jquery.slimscroll.min.js') ?>"></script>
    <script src="<?php echo base_url('assets/staff/plugins/jquery-cookie/jquery.cookie.js') ?>"></script>
    <!-- ================== END BASE JS ================== -->
    
    <!-- ================== BEGIN PAGE LEVEL JS ================== -->
    <script src="<?php echo base_url('assets/staff/plugins/gritter/js/jquery.gritter.js') ?>"></script>
    <script src="<?php echo base_url('assets/staff/plugins/flot/jquery.flot.min.js') ?>"></script>
    <script src="<?php echo base_url('assets/staff/plugins/flot/jquery.flot.time.min.js') ?>"></script>
    <script src="<?php echo base_url('assets/staff/plugins/flot/jquery.flot.resize.min.js') ?>"></script>
    <script src="<?php echo base_url('assets/staff/plugins/flot/jquery.flot.pie.min.js') ?>"></script>
    <script src="<?php echo base_url('assets/staff/plugins/sparkline/jquery.sparkline.js') ?>"></script>
    <script src="<?php echo base_url('assets/staff/plugins/jquery-jvectormap/jquery-jvectormap-1.2.2.min.js') ?>"></script>
    <script src="<?php echo base_url('assets/staff/plugins/jquery-jvectormap/jquery-jvectormap-world-mill-en.js') ?>"></script>
    <script src="<?php echo base_url('assets/staff/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js') ?>"></script>
    <script src="<?php echo base_url('assets/staff/js/dashboard.min.js') ?>"></script>
    <script src="<?php echo base_url('assets/staff/js/apps.min.js') ?>"></script>
    <!-- ================== END PAGE LEVEL JS ================== -->
    <script>
...
<!-- Mirrored from seantheme.com/color-admin-v1.4/admin/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Dec 2014 13:46:41 GMT -->
</html>
