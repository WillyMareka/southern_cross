  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="#">Under-Graduate</a></li>
...
<div class="jumbotron top-under">
</div>

<div class="admission">
   
   <div class="admissionno right">
	  <form class="form-inline" role="form">
         <div class="form-group">
           <label for="InputAdmission">Admission Number :</label>
           <input type="text" class="form-control Admlength" id="InputAdmission">
         </div>
      </form>
   </div>

   <div class="titleadmissionno left">
