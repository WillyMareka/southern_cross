...
background:#fdde0e;
    ...
    ');
    $html = ($data);
    $this->mpdf = new mPDF('', '', 0, '', 15, 15, 16, 16, 9, 9, '');
    $this->mpdf->SetTitle('Southern Cross Document');
    $this->mpdf->SetHTMLHeader('<em>SOUTHERN CROSS INSTITUTE OF TECHNOLOGY</em>');
    $this->mpdf->SetHTMLFooter('<em>Southern Cross</em>');
