...
<div class="shadow"></div>
	...
	<section class="testimonials wrapper">
		...
		<ul class="clearfix">
			...
			<li class="animated wow fadeInDown"  data-wow-delay=".2s">
				<p><img src="<?php echo base_url() .'assets/images/quotes.png'?>" alt="" class="quotes"/>a holder of a BSc. Law and an Associate of the Chartered Institute of Bankers (ACIB), is a career banker with 26 years working experience in the local banking industry in several senior capacities. He is the Company’s Financial Director and brings on board both legal and financial expertise and a wealth of financial management strategies to ensure business sustainability and continuity.
				<span class="triangle"></span>
				</p>
				<div class="client">
	...
	<footer>
		<div class="wrapper">
			<div class="rights">
				<img src="<?php echo base_url() .'assets/images/footer_logo.png'?>" alt="" class="footer_logo"/>
