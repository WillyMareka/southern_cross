...
<div class="navbar navbar-inverse" role="navigation">
  <div class="navbar-header"><a class="navbar-brand" href="#"><img src="<?php echo base_url() . 'assets/images/logo.png'?>" alt="Londinium"></a><a class="sidebar-toggle"><i class="icon-paragraph-justify2"></i></a>
  ...
  <ul class="nav navbar-nav navbar-right collapse" id="navbar-icons">
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="icon-paragraph-justify2"></i><span class="label label-default">6</span></a>
      <div class="popup dropdown-menu dropdown-menu-right">
        ...
        <ul class="popup-messages">
          <li class="unread"><a href="#"><img src="<?php echo base_url() .'assets/images/demo/users/face1.png'?>" alt="" class="user-face"><strong>Eugene Kopyov <i class="icon-attachment2"></i></strong><span>Aliquam interdum convallis massa...</span></a></li>
          <li><a href="#"><img src="<?php echo base_url() .'assets/images/demo/users/face2.png'?>" alt="" class="user-face"><strong>Jason Goldsmith <i class="icon-attachment2"></i></strong><span>Aliquam interdum convallis massa...</span></a></li>
          <li><a href="#"><img src="<?php echo base_url() .'assets/images/demo/users/face3.png'?>" alt="" class="user-face"><strong>Angel Novator</strong><span>Aliquam interdum convallis massa...</span></a></li>
          <li><a href="#"><img src="<?php echo base_url() .'assets/images/demo/users/face4.png'?>" alt="" class="user-face"><strong>Monica Bloomberg</strong><span>Aliquam interdum convallis massa...</span></a></li>
          <li><a href="#"><img src="<?php echo base_url() .'assets/images/demo/users/face5.png'?>" alt="" class="user-face"><strong>Patrick Winsleur</strong><span>Aliquam interdum convallis massa...</span></a></li>
        </ul>
      </div>
    </li>
    ...
    <li class="user dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><img src="<?php echo base_url() .'assets/images/profile-01.jpg'?>" alt=""><span>Chrispine Otaalo</span><i class="caret"></i></a>
...
<div class="page-container">
  ...
  <div class="sidebar collapse">
    <div class="sidebar-content">
      <!-- User dropdown -->
      <div class="user-menu dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="<?php echo base_url() .'assets/images/profile-01.jpg'?>" alt="">
        <div class="user-info">Chrispine Otaalo<span>Web Developer</span></div>
        </a>
        <div class="popup dropdown-menu dropdown-menu-right">
          <div class="thumbnail">
            <div class="thumb"><img alt="" src="<?php echo base_url() .'assets/images/profile-01.jpg'?>">
            ...
            <div class="caption text-center">
              <h6>Chrispine Otaalo <small>Web Developer</small></h6>
            </div>
          </div>
          <ul class="list-group">
            <li class="list-group-item"><i class="icon-pencil3 text-muted"></i> User Accounts <span class="label label-success">289</span></li>
            <li class="list-group-item"><i class="icon-people text-muted"></i> Phone Numbers <span class="label label-danger">892</span></li>
            <li class="list-group-item"><i class="icon-stats2 text-muted"></i> Classes <span class="label label-primary">92</span></li>
            <li class="list-group-item"><i class="icon-stack text-muted"></i> Balance
              <h5 class="pull-right text-danger">Ksh. 45.389</h5>
            </li>
          </ul>
        </div>
      </div>
      ...
      <ul class="navigation">
        ...
        <li><a href="#" class="expand"><span>Form components</span> <i class="icon-paragraph-justify2"></i></a>
          <ul>
        ...
        <li><a href="#" class="expand"><span>Interface components</span> <i class="icon-grid"></i></a>
          <ul>
        ...
        <li><a href="#" class="expand"><span>Layouts</span> <i class="icon-copy"></i></a>
          <ul>
        ...
        <li><a href="#" class="expand"><span>Task manager</span> <i class="icon-numbered-list"></i></a>
          <ul>
        ...
        <li><a href="#" class="expand"><span>User</span> <i class="icon-user"></i></a>
          <ul>
        ...
        <li><a href="#" class="expand"><span>Support</span> <i class="icon-bubble6"></i></a>
          <ul>
        ...
        <li><a href="#" class="expand"><span>Tables</span> <i class="icon-table2"></i></a>
          <ul>
        ...
        <li><a href="#" class="expand"><span>Invoice</span> <i class="icon-coin"></i></a>
          <ul>
            <li><a href="invoice.html">Invoice template</a></li>
            <li><a href="invoice_list.html">Invoice list</a></li>
          </ul>
        </li>
        <li><a href="#" class="expand"><span>Login page</span> <i class="icon-user-plus"></i></a>
          <ul>
            <li><a href="login_simple.html">Simple login form</a></li>
            <li><a href="login_advanced.html">Login form with user image</a></li>
          </ul>
        </li>
        <li><a href="#" class="expand"><span>Error pages</span> <i class="icon-warning"></i></a>
          <ul>
        ...
        <li><a href="#" class="expand"><span>Blank pages</span> <i class="icon-insert-template"></i></a>
          <ul>
  ...
  <div class="page-content">
    ...
    <div class="page-header">
      <div class="page-title">
        <h3>Dashboard <small>Welcome Chris. 1 hour since last visit</small></h3>
      </div>
    ...
    <div class="footer clearfix">
      <div class="pull-left">&copy; 2014. Evolve Softwares Admin Page by <a href="http://www.cotaalo.com">Chrispine Otaalo</a></div>
