...
<body>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="<?php echo base_url(). 'applications/diploma'?>">Diploma / Certificate</a></li>
      ...
      <div id="collapseOne" class="panel-collapse collapse">
        <div class="panel-body">
          <ol>
            ...
            <li>Diploma in Community Development and Social Work</li>
            <li>Diploma in HIV / AIDS Management</li>
      ...
      <div id="collapseTwo" class="panel-collapse collapse">
        <div class="panel-body">
          <ol>
            ...
            <li>Certificate in Community Development and Social Work</li>
            <li>Certificate in HIV / AIDS Management</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <div>
    ...
    <center>
    <p><h4><b>Registration for January 2015 intake is ongoing <br/><a href = "<?php echo base_url() .'applications/diploma'?>">Apply here. </a></p>
