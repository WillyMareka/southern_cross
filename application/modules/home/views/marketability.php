...
<html lang="en">
    ...
    <body>
                ...
                <div class="row">
                    <div class="span10 offset1">
                        <div class="flexslider">
                            <ul class="slides">
                                <li data-thumb="<?php echo base_url() .'assets/images/slider/1.jpg'?>">
                                ...
                                <li data-thumb="<?php echo base_url() .'assets/images/slider/2.jpg'?>">
                                ...
                                <li data-thumb="<?php echo base_url() .'assets/images/slider/5.jpg'?>">
                                    <img src="<?php echo base_url() .'assets/images/slider/5.jpg'?>">
                                    <p class="flex-caption">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et. Lorem ipsum dolor sit amet, consectetur.</p>
                                </li>
                                <li data-thumb="<?php echo base_url() .'assets/images/slider/6.jpg'?>">
        ...
        <div class="portfolio container">
            ...
            <div class="row">
                <div class="work span3">
                    ...
                    <div class="icon-awesome">
                        <a href="<?php echo base_url() .'assets/images/portfolio/work1.jpg'?>" rel="prettyPhoto"><i class="icon-search"></i></a>
                ...
                <div class="work span3">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor...</p>
                    <div class="icon-awesome">
                        <a href="<?php echo base_url() .'assets/images/portfolio/work2.jpg'?>" rel="prettyPhoto"><i class="icon-search"></i></a>
                        <a href="portfolio.html"><i class="icon-link"></i></a>
                    </div>
                </div>
                <div class="work span3">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor...</p>
                    <div class="icon-awesome">
                        <a href="<?php echo base_url() .'assets/img/portfolio/work3.jpg'?>" rel="prettyPhoto"><i class="icon-search"></i></a>
                        <a href="portfolio.html"><i class="icon-link"></i></a>
                    </div>
                </div>
                <div class="work span3">
                    <img src="<?php echo base_url() .'assets/img/portfolio/work4.jpg'?>" alt="">
                    <h4>Sit Amet Website</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor...</p>
                    <div class="icon-awesome">
                        <a href="<?php echo base_url() .'assets/img/portfolio/work4.jpg'?>" rel="prettyPhoto"><i class="icon-search"></i></a>
                        <a href="portfolio.html"><i class="icon-link"></i></a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="tabbable tabs-below">
                        <div class="tab-content">
                            <div class="tab-pane active" id="A">
                                <img src="<?php echo base_url() .'assets/images/testimonials/1.jpg'?>" title="" alt="">
                            ...
                            <div class="tab-pane" id="B">
                                <img src="<?php echo base_url() .'assets/images/testimonials/2.jpg'?>" title="" alt="">
                            ...
                            <div class="tab-pane" id="C">
                                <img src="<?php echo base_url() .'assets/images/testimonials/3.jpg'?>" title="" alt="">
                                <p>"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et. Lorem ipsum dolor sit amet, consectetur..."<br /><span class="violet">Lorem Ipsum, dolor.co.uk</span></p>
                            </div>
        ...
        <script src="<?php echo base_url() .'assets/js/jquery.ui.map.min.js'?>"></script>
