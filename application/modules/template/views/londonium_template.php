  ...
  <div class="sidebar collapse">
    <div class="sidebar-content">
      ...
      <ul class="navigation">
        ...
        <li><a href="#"><span>Lecturers</span> <i class="icon-user4"></i></a></li>
        ...
        <li class="active"><a href="#" class="expand" id="second-level"><span>School Setup</span> <i class="icon-cogs"></i></a>
          <ul>
