...
<div class="jumbotron top-announcement">
  <div class="first-header-ann">
    <h1>ANNOUNCEMENTS</h1>
    <p><strong>Southern Cross Institute of Tropical Medicine</strong> is a Mid-Level Medical Training College <br/>located near <strong>Kibuye Market</strong> on a premises previously occupied by <br/><strong>Lake Institute of Tropical Medicine</strong> <small>(LITMIED)</small>. </p>
  </div>
</div>
    ...
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
          1.  CERTIFICATE IN COMMUNITY HEALTH & DEVELOPMENT
        </a>
      </h4>
    </div>
    ...
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
          2.  DIPLOMA IN COMMUNITY HEALTH & DEVELOPMENT
        </a>
      </h4>
    </div>
    ...
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
          3.  CERTIFICATE IN MEDICAL & PSYCHOLOGICAL COUNSELING
        </a>
      </h4>
    </div>
...
<hr>
 <div class="bottom_announce">
  ...
  A strategic alliance with a USA based Medical Institution will also facilitate <br/>
  deployment of Nursing and Social Work student into the US market.<br/>

</div>
<hr>
<div class="special_announcement">
  <strong>Registration of students begins on Friday 26th September 2014 until 30th September 2014 for new intakes. <br/><br/>
